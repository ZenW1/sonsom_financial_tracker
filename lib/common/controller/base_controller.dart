...
enum ApiState { loading, failure, success,manual}
...
mixin BaseController {
  ...
  Future<void> createItem(Future<Either<String, bool>> apiCallback) async {
    _apiOperationTemplate(apiCallback);
  }

  Future<void> updateItem(Future<Either<String, bool>> apiCallback) async {
    _apiOperationTemplate(apiCallback);
  }

  Future<void> deleteItem(Future<Either<String, bool>> apiCallback) async {
    _apiOperationTemplate(apiCallback);
  }
}
